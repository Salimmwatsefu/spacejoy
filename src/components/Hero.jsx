...
function Hero() {
  return (
    ...
    <div className="h-56 sm:h-64 xl:h-[550px] 2xl:h-96 ">
  <Carousel slideInterval={5000}>


    <img
      src="https://images.unsplash.com/photo-1621293954908-907159247fc8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDJ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=1500&q=80"
      alt="..."
    ...
    <img
      src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1500&q=80"
      alt="..."
      className='opacity-50'
    />
    <img
      src="https://images.unsplash.com/photo-1604328727766-a151d1045ab4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDN8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=1500&q=80"
      alt="..."
      className='opacity-50'
    />
    <img
      src="https://images.unsplash.com/photo-1571071001565-f89ac540effc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDExfHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=1500&q=80"
      alt="..."
      className='opacity-50'
    />
    <img
      src="https://images.unsplash.com/photo-1657978837873-5a6938c382ec?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTczfHxtb2Rlcm4lMjBvZmZpY2V8ZW58MHx8MHx8&auto=format&fit=crop&w=1500&q=80"
      alt="..."
      className='opacity-50'
    />
  </Carousel>
...
<div className='absolute -mt-96 text-6xl font-bold text-white ml-20 '>
    <p>Book a unique space for <br/> your next video shoot</p>


<div class="flex mt-10 w-80">
    ...
    <select id="states" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg border-l-gray-100 dark:border-l-gray-700 border-l-2 focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ">
